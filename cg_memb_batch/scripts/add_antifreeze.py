...
# Named arguments
parser.add_argument(
    "-c", "--gro", help="The name of the input .gro file", required=True)
parser.add_argument("-co", "--outgro",
                    help="The name of the output .gro file", required=True)
parser.add_argument(
    "-p", "--top", help="The name of the input .top file", required=True)
parser.add_argument("-po", "--outtop",
                    help="The name of the output .top file", required=True)
