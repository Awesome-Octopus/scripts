...
standardint = 2.4168; % Standard from experiment
standardconc = 1; % Standard from experiment
...
conclabel = [sprintf('Concentration = %.3f ',conc) '\muM']; % Assigns a string to the obtained value for T1 on the plot
