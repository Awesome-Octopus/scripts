...
if symm_vects_list:
    ...
    sca = ax.scatter(symm_vects_list[:,0], symm_vects_list[:,1], symm_vects_list[:,2], c=indices, cmap='viridis', label=f'chain {j+1}')
...
for j in range(len(chains)):
    ...
    sca = ax.scatter(hel_vects_list[:,j,0], hel_vects_list[:,j,1], hel_vects_list[:,j,2], c=indices, cmap='viridis', label=f'chain {j+1}')
